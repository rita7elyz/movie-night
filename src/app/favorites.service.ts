  ...
  export class FavoritesService {
    ...
    addToFavorites(movieInfo){
      ...
      console.log(movieInfo, 'url',`${this.baseUrl}${this.appUserUrl}${this.sessionIdUrl}/movies${this.accessTokenUrl}`)
    ...
    removeFave(favoriteMovie){
      ...
      this.sessionIdUrl = `${this.mySessionId}`
      this.accessTokenUrl = `?access_token=${this.mySessionToken}` 
      console.log(`${this.baseUrl}${this.appUserUrl}${this.sessionIdUrl}/movies/${favoriteMovie}`)
